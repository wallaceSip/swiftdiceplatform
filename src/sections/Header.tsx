    ...
    <>
      {bonusHelp && (
        <Modal onClose={() => setBonusHelp(false)}>
          ...
          <p>
            You have <span className='notranslate'><b><TokenValue amount={balance.bonusBalance} /></b></span> worth of free plays. This bonus will be applied automatically when you play.
          </p>
        </Modal>
      )}
      {jackpotHelp && (
